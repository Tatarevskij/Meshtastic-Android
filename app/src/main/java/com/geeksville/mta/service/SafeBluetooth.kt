...
import com.geeksville.mta.concurrent.CallbackContinuation
import com.geeksville.mta.concurrent.Continuation
import com.geeksville.mta.concurrent.SyncContinuation
import com.geeksville.mta.android.bluetoothManager
import com.geeksville.mta.util.exceptionReporter
...
class SafeBluetooth(private val context: Context, private val device: BluetoothDevice) :
    ...
    private class BluetoothContinuation(
        val tag: String,
        val completion: com.geeksville.mta.concurrent.Continuation<*>,
     ...
     * 06-29 08:47:15.035 29788-30155/com.geeksville.mta D/BluetoothGatt: cancelOpen() - device: 24:62:AB:F8:40:9A
    06-29 08:47:15.036 29788-30155/com.geeksville.mta D/BluetoothGatt: close()
    06-29 08:47:15.037 29788-30155/com.geeksville.mta D/BluetoothGatt: unregisterApp() - mClientIf=5
    06-29 08:47:15.037 29788-29813/com.geeksville.mta D/BluetoothGatt: onClientConnectionState() - status=0 clientIf=5 device=24:62:AB:F8:40:9A
    06-29 08:47:15.037 29788-29813/com.geeksville.mta W/BluetoothGatt: Unhandled exception in callback
    ...
    fun closeGatt() {
        ...
        gatt?.let { g ->
            ...
            try {
                ...
                //com.geeksville.mta.service.SafeBluetooth.closeGatt
