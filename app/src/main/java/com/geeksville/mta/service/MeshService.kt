...
import com.geeksville.mta.analytics.DataPair
import com.geeksville.mta.android.GeeksvilleApplication
import com.geeksville.mta.android.Logging
import com.geeksville.mta.concurrent.handledLaunch
import com.geeksville.mta.*
import com.geeksville.mta.LocalOnlyProtos.LocalConfig
import com.geeksville.mta.LocalOnlyProtos.LocalModuleConfig
import com.geeksville.mta.MeshProtos.MeshPacket
import com.geeksville.mta.MeshProtos.ToRadio
import com.geeksville.mta.android.hasBackgroundPermission
import com.geeksville.mta.database.MeshLogRepository
import com.geeksville.mta.database.PacketRepository
import com.geeksville.mta.database.entity.MeshLog
import com.geeksville.mta.database.entity.Packet
import com.geeksville.mta.model.DeviceVersion
import com.geeksville.mta.repository.datastore.RadioConfigRepository
import com.geeksville.mta.repository.location.LocationRepository
import com.geeksville.mta.repository.network.MQTTRepository
import com.geeksville.mta.repository.radio.BluetoothInterface
import com.geeksville.mta.repository.radio.RadioInterfaceService
import com.geeksville.mta.repository.radio.RadioServiceConnectionState
import com.geeksville.mta.util.*
...
class MeshService : Service(), Logging {
    ...
    companion object : Logging {
        ...
        fun createIntent() = Intent().setClassName(
            "com.geeksville.mta",
            "com.geeksville.mta.service.MeshService"
        )
