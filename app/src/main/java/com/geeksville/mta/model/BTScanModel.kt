...
import com.geeksville.mta.repository.bluetooth.BluetoothRepository
import com.geeksville.mta.repository.nsd.NsdRepository
import com.geeksville.mta.repository.radio.InterfaceId
import com.geeksville.mta.repository.radio.RadioInterfaceService
import com.geeksville.mta.repository.usb.UsbRepository
...
class BTScanModel @Inject constructor(
    ...
    companion object {
        ...
        const val ACTION_USB_PERMISSION = "com.geeksville.mta.USB_PERMISSION"
    }
}
