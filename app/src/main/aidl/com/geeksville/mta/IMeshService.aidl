// com.geeksville.mta.IMeshService.aidl
...
<queries>
    <package android:name="com.geeksville.mta" />
</queries>
...
Once you have bound to the service you should register your broadcast receivers per https://developer.android.com/guide/components/broadcasts#context-registered-receivers
    ...
    // com.geeksville.mta.x broadcast intents, where x is:
    ...
    // (i.e. com.geeksville.mta.RECEIVED.TEXT_MESSAGE_APP) else the numeric portnum will be included as a base 10 integer (com.geeksville.mta.RECEIVED.4403 etc...)
